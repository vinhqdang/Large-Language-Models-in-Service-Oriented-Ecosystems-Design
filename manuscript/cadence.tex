...
The complete CADENCE implementation --- the retrieval index, the 26-tactic knowledge graph, every deliberation/solver/critique prompt, the evaluation harness, and the aggregate results underlying Tables~\ref{tab:pilot} and~\ref{tab:scaled} (per-system, not yet per-item) --- is publicly available at:
