...
\midrule
\texttt{zero\_shot}             & --- & 0.810 & 1.90 & 0.182 & 0.243 \\
\texttt{retrieval\_only}        & --- & 0.817 & 1.67 & 0.229 & 0.250 \\
\texttt{multiagent\_no\_solver} & --- & 0.809 & 0.59 & 0.125 & 0.092 \\
\texttt{cadence\_full}          & 5   & 0.802 & 0.62 & 0.149 & 0.115 \\
\texttt{cadence\_full}          & 2   & 0.801 & 0.80 & 0.122 & 0.097 \\
\bottomrule
\end{tabular}
...
Across the pilot run, both scaled-run budget conditions, and both baselines and CADENCE throughout, BERTScore F1 stays in a narrow 0.801--0.819 band while ROUGE-1 and METEOR are consistently, noticeably lower for the two deliberation-based systems (\texttt{multiagent\_no\_solver} and \texttt{cadence\_full}) than for the two single-pass systems --- the same qualitative pattern holds across both independent runs, which we take as evidence the pattern is systematic rather than a small-sample artifact of either run alone. We discuss why in Section~\ref{sec:discussion}.
